%% PlotScript: Variable Slice Allocation
% Eventually make into results
...
%%
load('..\output\plotScript_variableSliceAllocation_allocationA_APs_16slices\dataStructures_6recordings.mat')
dataStructure_A = dataStructure;
dataStructureMuxCumAP_A = dataStructureMuxCumAP;

load('..\output\plotScript_variableSliceAllocation_allocationB_APs_16slices\dataStructure.mat')
