...
% For TDT19
% InVitro measurements taken 20190716. Gamry measurements taken 20190712
...
[ NSxFileArray, NSxbasicHeader, NSxchannelHeader, NSxTimeStamps ] = ...
    NSxGetMemMapFile( '20190716_TDT19_InVitro_30s.ns5' );
...
[fImp, Zreal, Zim, Phase] = ...
    extractImpedanceDataGlobal('..\rawData\Gamry\2019-07-12_TDT19_InVitro');
kT=300*1.38e-23;
Z = sqrt(Zreal.^2);
