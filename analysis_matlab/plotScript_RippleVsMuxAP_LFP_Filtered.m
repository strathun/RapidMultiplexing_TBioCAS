...
muxFileName    = '2019_7_22_13_29_25_16_2097152_3_4_5_2_1_6_0_7_15_8_9_14_13_10_11_12_smpls_raw.mat';
...
% Plot Raw
for ii = 1:totalChannels
    figure(dataStructure(ii).electrode + 100)
...
% Plot Spike Filtered
for ii = 1:totalChannels
    figure(dataStructure(ii).electrode + 200)
    subplot(2,1,dataStructure(ii).figIndex)
